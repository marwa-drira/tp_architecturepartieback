...
public class ProduitRESTController {
    ...
    public  List<Produit> getAllProduits(@RequestParam(name = "designation",required = false) String designation,@RequestParam(name = "code",required = false) String code) {   
    	List<Produit> result = null;
    	if(designation != "" &&  code != "" && designation != null &&  code != null) {
            result =  produitRepos.findByDesignationAndCode(designation,code);
    	}
    	else if(designation != "" && designation != null) {
            result =  produitRepos.findByDesignation(designation);
    	}
    	else if(code != "" && code != null) {
            result =  produitRepos.findByCode(code);	
    	} else {
            result =  produitRepos.findAll();	
    	}
    	/**to do other filters */
    	return result;
