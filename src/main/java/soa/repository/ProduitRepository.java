...
public interface ProduitRepository extends JpaRepository<Produit, Long> {
	...
	@Query("select p from Produit p where p.code like %:x% ")
	public List<Produit> findByCode(@Param("x") String mc);
	
	@Query("select p from Produit p where p.designation like %:x% and p.code like %:y%")
	public List<Produit> findByDesignationAndCode(@Param("x") String designation, @Param("y") String code);
